        ...
        if (df_hash == self.df_hash) and (
            ...
            if (
                ...
                warnings.warn(
                    ...
                    f"Currently running on pandas-profiling {VERSION} , while loaded data is generated by pandas_profiling, {loaded_description_set['package']['pandas_profiling_version']}."
                )
