...
from pandas_profiling.report.structure.clusters import get_cluster_items
from pandas_profiling.report.structure.correlations import get_correlation_items
from pandas_profiling.report.structure.outliers import get_outlier_items
...
def get_sample_items(sample: dict):
    ...
    """
    items = []
    items.append(Sample(sample=sample, name="", anchor_id="sample",))
    return items
...
def get_report_structure(summary: dict) -> Renderable:
    ...
    with tqdm(
        ...
        cluster_items = get_cluster_items(summary)
        ...
        outlier_items = get_outlier_items(summary)
    ...
    footer = HTML(
        content="Report generated with <a href='https://github.com/luca310795/pandas-profiling-extended'>pandas-profiling-extended</a>."
    )
